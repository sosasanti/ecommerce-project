...
export async function checkOut() {
    ...
    if (cart && cart.items){
        ...
        //array de obj, con la info que necesita stripe
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            success_url: process.env.NODE_ENV === "development" ? 'http://localhost:3000/payment/success' : "https://santisosa-ecommerce.vercel.app/payment/success",
            cancel_url: process.env.NODE_ENV === "development" ? 'http://localhost:3000/payment/cancel' : "https://santisosa-ecommerce.vercel.app/payment/cancel",
            metadata: {
                userId: user.id,
            }
        });
